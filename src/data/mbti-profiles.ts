...
export const mbtiProfiles: Record<string, MBTIProfile> = {
  ...
  'ENTJ': {
    ...
    tagline: '我来领导这个',
    emoji: '👔',
    color: '#1e3a8a', // Sapphire Blue (Blue 900)
  ...
  'ISTJ': {
    ...
    tagline: '言出必行，一诺千金',
    emoji: '📋',
    color: '#d4b996', // Champagne
    colorSecondary: '#e6ccb2',
  ...
  'ISFJ': {
    ...
    tagline: '默默守护你所爱的一切',
    emoji: '🛡️',
    color: '#a1a1aa', // White (Zinc 400 for visibility)
  ...
  'ISTP': {
    ...
    tagline: '动手实践出真知',
    emoji: '🔧',
    color: '#475569', // Cyan-Grey (Slate 600)
